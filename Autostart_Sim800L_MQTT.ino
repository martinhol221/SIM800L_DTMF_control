// версия для удаленного запуска двигателя по протоколу MQTT. ТЕСТ
...
//String SENS = "Citroen";              // Название устройства (придумать свое Citroen 566 или др. для отображения в программе и на карте)
...
void setup() {
  ...
  Serial.println("MQTT | TEL:"+call_phone+" | 12/12/2017"); 
  delay (1000);
...
void response (){
 ...
 /*    } else if (at.indexOf("+DTMF: ")  > -1)      {String key = at.substring(at.indexOf("+DTMF: ")+7, at.indexOf("+DTMF: ")+8);
      ...
      } else if (at.indexOf("SMS Ready") > -1 )     {SIM800.println("AT+CMGDA=\"DEL ALL\";+CLIP=1;+DDET=1"), delay(300);       
