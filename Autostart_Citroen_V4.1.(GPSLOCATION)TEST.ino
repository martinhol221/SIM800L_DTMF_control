...
void setup() {
  ...
  Serial.println("Starting. | V4.0 | SIM800L+narodmon.ru. | MAC:"+MAC+" | NAME:"+SENS+" | APN:"+APN+" | TEL:"+call_phone+" | 26/11/2017"); 
  delay (2000);
  SIM800_reset();
...
//                     // delay(20), SIM800.println("AT+CMGDA=\"DEL ALL\""), delay(20); //  и удаляем их все
  ...
  //  } else if (at.indexOf("+SAPBR: 1,1") > -1 )                    {SIM800.println("AT+CIPSTART=\"TCP\",\""+SERVER+"\",\""+PORT+"\""), delay (1000);    
