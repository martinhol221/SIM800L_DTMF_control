...
* если напряжение в мониторе порта не соответствует действительности то необходимо подобрать `m = 65.....72;`

* если температура с датчиков отображается 85, 86, 87, 88 градусов, то датчики физически не подключены, проверьте подключение
