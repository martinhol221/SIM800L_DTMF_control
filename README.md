...
* если после этого связи с модемом нет то проверьте какие логические уровни на ножках `TX` и `RX` модема, допустимый диапазон 2.5...3.1, при 3.3 тоже работать будет но это кощунство. [лог нормальнойработы](https://raw.githubusercontent.com/martinhol221/SIM800L_DTMF_control/master/img/normal.log)
