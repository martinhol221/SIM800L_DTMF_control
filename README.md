...
* если напряжение в мониторе порта не соответствует действительности то необходимо подобрать `m = 66.91;` от 65 до 72.

* если температура с датчиков указана 85,86,87,88 градусов то датчики физически не подключены, проверьте подключение
