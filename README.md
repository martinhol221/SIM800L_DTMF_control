...
Определение местоположения модема по GPS-координатам, с использованием информации базовых станциий сотового оператора, точность при этом как в смартфоне без GPS от 100 до 800 м, в зависимосте от местности, в городе обычно 100-200 м.
...
* Для активации отправки GPS-кординат на народмон, в том числе для построения треков, нужно раскоментировать закоментированные строки:
...
## 9. Отключение зажигания по таймеру, при низком напряжении и превышении температуры выше 70 градусов
...
За отключение при достижении температуры в 70 градусов строка 
...
[Подделка на подделку ELM327, или как еще читать температуру ДВС] (https://www.drive2.ru/c/479335393737572613/) опыт работы с K-line шиной по протоколу ISO 14230-4 kwp
