...
На основании УК РФ Статья 138.1. Незаконный оборот специальных технических средств, предназначенных для негласного получения информации, 
запрещается вносить конструктивные изменения в устройство, а именно подпаивать микрофон, что превратит ваше устройство в спейц средство и у вас будут проблемы с законом. 
...
SIM800.println("AT+CIPGSMLOC=1,1"),    delay (3000);    
                                              ...
                                              delay (200),
`
Это хоть не GPS треккер но в теории модем может определять свое расположение по информации базовых станциий сотового оператора, аналогично как и в смартфонах без GPS точность при этом от 100 до 800 м, в зависимосте от местности, в городе обычно 100-200 м.
