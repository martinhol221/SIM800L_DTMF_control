...
* добавлен агларитм активациии и деактивации автопрогрева

* добавлен агларитм активациии и деактивации отправки данных на сервер
...
* ввод `567` включает таймер автопрогрева
...
Активация `567` и дезактивация `567`, либо нажанием педали STOP
